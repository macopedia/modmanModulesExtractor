...
class Module
{
    ...
    {
        $this->modmanLines[] = $source . " \t" . $target;
    }
...
//TODO: custom themes are not copied.
    ...
    {
        $this->addModmanLine("#Autogenerated Modman file " . date('YYYY-m-d H:i:s'));
        file_put_contents($this->moduleModmanPath . 'modman', "\n" . implode("\n", $this->modmanLines), FILE_APPEND);
    }
